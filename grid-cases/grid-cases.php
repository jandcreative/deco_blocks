...
<section <?php echo $anchor;?>class="<?php echo $class_name;?>">
   ...
   <div class="box" style="<?php if( 'yes' == $select_background_color_01 ): ?>background-color:<?php echo $background_box_01;?>;<?php endif; ?><?php if( 'yes' == $select_background_image_01 ): ?>background-image: url(<?php echo $background_image_box_01;?>);background-size: cover; background-repeat: no-repeat; <?php endif; ?>">
      <div class="frame">
         <div class="content">
            <?php if( !empty( $category_01 ) ): ?>
               <span style="color:<?php echo $color_01;?>"><?php echo $category_01;?></span>
            <?php endif; ?>
            <p style="color:<?php echo $color_01;?>"><?php echo $text_01;?></p>
            <a style="color:<?php echo $color_01;?>" href="<?php echo $url_01;?>"><?php echo $link_01;?></a>
   ...
   <div class="box" style="<?php if( 'yes' == $select_background_color_02 ): ?>background-color:<?php echo $background_box_02;?>;<?php endif; ?><?php if( 'yes' == $select_background_image_02 ): ?>background-image: url(<?php echo $background_image_box_02;?>);background-size: cover; background-repeat: no-repeat; <?php endif; ?>">
      <div class="frame">
         <div class="content">
            <?php if( !empty( $category_02 ) ): ?>
               <span style="color:<?php echo $color_02;?>"><?php echo $category_02;?></span>
            <?php endif; ?>
   ...
   <div class="box" style="<?php if( 'yes' == $select_background_color_03 ): ?>background-color:<?php echo $background_box_03;?>;<?php endif; ?><?php if( 'yes' == $select_background_image_03 ): ?>background-image: url(<?php echo $background_image_box_03;?>);background-size: cover; background-repeat: no-repeat; <?php endif; ?>">
      <div class="frame">
         <div class="content">
            <?php if( !empty( $category_03 ) ): ?>
               <span style="color:<?php echo $color_03;?>"><?php echo $category_03;?></span>
            <?php endif; ?>
            <p style="color:<?php echo $color_03;?>"><?php echo $text_03;?></p>
            <a style="color:<?php echo $color_03;?>" href="<?php echo $url_03;?>"><?php echo $link_03;?></a>
   ...
   <div class="box" style="<?php if( 'yes' == $select_background_color_04 ): ?>background-color:<?php echo $background_box_04;?>;<?php endif; ?><?php if( 'yes' == $select_background_image_04 ): ?>background-image: url(<?php echo $background_image_box_04;?>);background-size: cover; background-repeat: no-repeat; <?php endif; ?>">
      <div class="frame">
         <div class="content">
            <?php if( !empty( $category_04 ) ): ?>
               <span style="color:<?php echo $color_04;?>"><?php echo $category_04;?></span>
            <?php endif; ?>
            <p style="color:<?php echo $color_04;?>"><?php echo $text_04;?></p>
            <a style="color:<?php echo $color_04;?>" href="<?php echo $url_04;?>"><?php echo $link_04;?></a>
   ...
   <div class="box" style="<?php if( 'yes' == $select_background_color_05 ): ?>background-color:<?php echo $background_box_05;?>;<?php endif; ?><?php if( 'yes' == $select_background_image_05 ): ?>background-image: url(<?php echo $background_image_box_05;?>);background-size: cover; background-repeat: no-repeat; <?php endif; ?>">
      <div class="frame">
         <div class="content">
            <?php if( !empty( $category_05 ) ): ?>
               <span style="color:<?php echo $color_05;?>"><?php echo $category_05;?></span>
            <?php endif; ?>
            <p style="color:<?php echo $color_05;?>"><?php echo $text_05;?></p>
            <a style="color:<?php echo $color_05;?>" href="<?php echo $url_05;?>"><?php echo $link_05;?></a>
   ...
   <div class="box" style="<?php if( 'yes' == $select_background_color_06 ): ?>background-color:<?php echo $background_box_06;?>;<?php endif; ?><?php if( 'yes' == $select_background_image_06 ): ?>background-image: url(<?php echo $background_image_box_06;?>);background-size: cover; background-repeat: no-repeat; <?php endif; ?>">
      <div class="frame">
         <div class="content">
            <?php if( !empty( $category_06 ) ): ?>
               <span style="color:<?php echo $color_06;?>"><?php echo $category_06;?></span>
            <?php endif; ?>
            <p style="color:<?php echo $color_06;?>"><?php echo $text_06;?></p>
            <a style="color:<?php echo $color_06;?>" href="<?php echo $url_06;?>"><?php echo $link_06;?></a>
